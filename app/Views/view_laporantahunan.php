                ...
                <div class="container-fluid">
                    ...
                    <center><a href="<?= base_url('LaporanTahunan/export');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Excel</a></center>
                    <!-- DataTales Example -->
